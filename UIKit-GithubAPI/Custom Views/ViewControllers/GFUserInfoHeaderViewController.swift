...
//  UIKit-GithubAPI
//
//  Created by Naela Fauzul Muna on 04/02/26.
//
...
struct GFUserInfoHeaderViewControllerPreview: UIViewControllerRepresentable {
    typealias UIViewControllerType = GFUserInfoHeaderViewController
...
#Preview {
    GFUserInfoHeaderViewControllerPreview()
}
